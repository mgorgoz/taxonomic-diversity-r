...
```{r karsilastirma, fig.width=10, fig.height=6, fig.alt="Cesitli ve baskin topluluklar icin cesitlilik indekslerinin cubuk grafigi karsilastirmasi"}
...
```{r ornek_rare_plot, fig.width=8, fig.height=5, fig.alt="Shannon indeksi icin orneklem buyuklugune karsi seyreltme egrisi"}
