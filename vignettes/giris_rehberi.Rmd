...
3. **Ozkan (2018; 2022) Deng entropisi tabanli**: pTO (uTO, TO, uTO+, TO+) ve guclendirilmis tahmin ediciler
...
Her turun **Westhoff-Maarel ortu-bolluk degeri** (1--9 olcegi) ve **7 taksonomik seviyesi** vardir.
...
- Ozkan, K. & Mert, A. (2022). Deng entropisi tabanli taksonomik cesitlilik
  olculerinin karsilastirilmasi ve guclendirilmis tahmin edicilerin
  tanitilmasi. *FORESTIST*, 72(2). DOI: 10.5152/forestist.2021.21025
